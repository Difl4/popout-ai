"""Pure-integer @njit kernels for PopOut — no Python objects cross the JIT boundary.

Single Responsibility: this module owns only JIT-compiled math functions.
NumbaMCTS and FlatNumbaMCTS import from here; nothing else should.
...
# ── Flat-tree kernels (used by FlatNumbaMCTS) ────────────────────────────────
