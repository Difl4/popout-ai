"""Unit tests for the @njit kernel functions in src/algorithms/mcts/kernels.py.

Each kernel is tested in isolation against the Python reference implementation
(rules.py / bitboard.py) to guarantee mathematical equivalence.
...
from src.engine.rules import has_won, evaluate_after_move
from src.algorithms.mcts.kernels import (
    nb_has_won,
    nb_legal_moves,
    nb_apply_move,
...
def _warm_kernels():
    ...
    from src.algorithms.mcts.numba_mcts import warmup
    warmup()
